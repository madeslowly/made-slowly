...
Gem::Specification.new do |spec|
  spec.name                    = 'made-slowly'
  spec.version                 = Mygem::VERSION
  spec.authors                 = ['Made Slowly']
  spec.email                   = ['arran@madeslowly.co.uk']
  spec.summary                 = %q{A stylish jekyll theme designed for developers}
  spec.description             = %q{A Jekyll theme designed for freelance web developers.}
  spec.homepage                = 'https://github.com/madeslowly/made-slowly'
  spec.license                 = 'MIT'
